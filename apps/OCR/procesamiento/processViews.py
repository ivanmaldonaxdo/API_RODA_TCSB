        ...
        try:
            ...
            try:
                ...
                if cliente.is_active:
                    ...
                    print("Rut Emisor",data.get('rut_emisor'))
                ...
                if str(e) == "list index out of range":
                    ...
                    error = "No existe algun cliente relacionado al rut {}" .format(rut_client)
                elif str(e) =="'NoneType' object has no attribute 'get'":
                    error = "No existe plantilla de Queries o Nro Cliente no encontrado" 
                else:
                    error = str(e)
                print(error)
                return Response({
