...
class procesoautomatico(ViewSet):
    ...
    def pruebausu(self,request):
        url = 'http://100.26.4.115/clientes/'
        x = request.get(url)
    ...
    def procesook(self,request):
        ...
        #http://100.26.4.115/documentos/process_docs/' procesa archivos
        #http://100.26.4.115/documentos/search_docs/'; los busca
        #const url = 'http://100.26.4.115/procesados/' busca procesados
