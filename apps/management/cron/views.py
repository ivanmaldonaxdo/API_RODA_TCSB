...
class StatusForCron(viewsets.GenericViewSet):
    ...
    #http://100.27.17.66/cron/actualizar_parametros_cron/
    ...
    #http://100.27.17.66/cron/info_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://100.27.17.66/cron/estado_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://100.27.17.66/cron/verificar_status/
    @action(detail=False, methods=['get'])
