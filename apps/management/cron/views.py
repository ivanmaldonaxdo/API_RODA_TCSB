...
class StatusForCron(viewsets.GenericViewSet):
    ...
    #http://100.26.4.115/cron/actualizar_parametros_cron/
    ...
    #http://100.26.4.115/cron/info_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://100.26.4.115/cron/estado_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://100.26.4.115/cron/verificar_status/
    @action(detail=False, methods=['get'])
