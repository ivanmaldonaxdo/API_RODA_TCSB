...
class StatusForCron(viewsets.GenericViewSet):
    ...
    #http://3.219.56.115/cron/actualizar_parametros_cron/
    ...
    #http://3.219.56.115/cron/info_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://3.219.56.115/cron/estado_cron/
    @action(detail=False, methods=['get'])
    ...
    #http://3.219.56.115/cron/verificar_status/
    @action(detail=False, methods=['get'])
