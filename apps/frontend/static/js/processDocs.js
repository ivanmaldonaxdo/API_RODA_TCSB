...
function getDocs(folio, tpServicio,rut_client, rut_receptor,fecha = null) {
    ...
    const url = 'http://100.27.17.66/documentos/search_docs/';
...
async function getDataClient (rutCliente) {
    const url = new URL("http://100.27.17.66/clientes/");
...
async function getDataProv(rutProv,nomProv = "") {
    const url = new URL("http://100.27.17.66/proveedores/");
...
function processDocs(indexRow, documento) {
    ...
    const url = 'http://100.27.17.66/documentos/process_docs/';
