...
function setSucursales() {
    const url = new URL("http://100.26.4.115/sucursales/");
    fetch(url, {
        method: 'GET',
        headers: {
...
async function setDataClientes() {
    const url = new URL("http://100.26.4.115/clientes/");
    const res = await fetch(url, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
...
function getProcesedDocs(paramsURL) {
    const url = new URL("http://100.26.4.115/procesados/");
    ...
    // const url = 'http://100.26.4.115/procesados/';
    fetch(url, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
